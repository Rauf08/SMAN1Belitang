        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"> Tambah Berita</legend>
                <?php
                ...
                <form class="form-horizontal" action="panel_admin/simpan_kat/t" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <input type="text" name="judul_kat" class="form-control" placeholder="Judul Berita" value="" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <textarea type="text" name="ket_kat" class="form-control ckeditor" id="ckedtor" placeholder="Isi Berita" required></textarea>
                    </div>
                  </div>
                  <hr>
