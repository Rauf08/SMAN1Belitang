    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title"> Data Kurikulum</h5>
          <!-- <hr style="margin:0px;"> -->
          ...
          <tbody>
              ...
              foreach ($v_isi->result() as $baris) {?>
                <tr>
                  ...
                  <td align="center">
                      <a href="panel_admin/data_kurikulum/e/<?php echo $baris->id_isi; ?>" class="btn btn-success btn-xs" title="Edit"><i class="icon-pencil"></i></a>
                  </td>
                </tr>
              <?php
              } ?>
