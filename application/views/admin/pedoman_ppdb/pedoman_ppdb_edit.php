        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"> Pedoman PPDB </legend>
                <?php
                ...
                <form class="form-horizontal" action="panel_admin/simpan_kat/e/<?php echo $query->id_kat; ?>" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="nama_kat" value="pedoman_ppdb">
                  <div class="form-group">
                    <label class="control-label col-lg-12">Judul</label>
                    <div class="col-lg-12">
                      <input type="text" name="judul_kat" class="form-control" placeholder="Judul" value="<?php echo $query->judul_kat; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <textarea type="text" name="ket_kat" class="form-control ckeditor" id="ckedtor" placeholder="Isi" required><?php echo $query->ket_kat; ?></textarea>
                    </div>
                  </div>
                  <hr>
