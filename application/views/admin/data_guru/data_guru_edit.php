        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"> Edit Data Guru <?php echo $query->judul_isi; ?></legend>
                <?php
                ...
                <form class="form-horizontal" action="panel_admin/simpan_isi/e/<?php echo $query->id_isi; ?>" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="nama_isi" value="data_guru">
                  ...
                  <hr>
                  <a href="panel_admin/data_guru" class="btn btn-default"><< Data Guru</a>
