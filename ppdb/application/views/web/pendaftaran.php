...
<head>
    ...
    <title>PPDB SMA NEGERI 1 BELITANG</title>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMA NEGERI 1 BELITANG</strong></h2>
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">SMA NEGERI 1 BELITANG</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
