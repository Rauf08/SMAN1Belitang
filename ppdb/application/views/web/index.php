...
<head>
    ...
    <title>PPDB Online | SMA NEGERI 1 BELITANG</title>
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px">PPDB ONLINE <br> SMA NEGERI 1 BELITANG</span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 portfolio-item">
                    <a href="http://www.sman1belitang.sch.id#callout" target="_blank" class="portfolio-link">
                        <div class="caption">
                        ...
                        <span class="btn btn-success btn-block">sman1belitang.sch.id</span>
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify">
                    <p>SMA NEGERI 1 BELITANG menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                    dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru tidak menggunakan formulir konvensional hanya dengan mengakses website PPDB Online SMA NEGERI 1 BELITANG. </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="col-lg-12 text-center">
                                ...
                                <li>Calon Siswa mendaftarkan diri atau melakukan <b><a href="pendaftaran">Pendaftaran PPDB <i>online</i></a></b> melalui website <b><a href="">PPDB SMA NEGERI 1 BELITANG</a></b>.</li>
                                <li>Setelah Calon Siswa berhasil melakukan pendaftaran, Calon siswa wajib melakukan <b>Print Out Pendaftaran & Mempersiapkan Kelengkapan Berkas PPDB SMA NEGERI 1 BELITANG</b>.</li>
                                <li>Calon siswa datang ke SMA NEGERI 1 BELITANG untuk <b>VERIFIKASI</b>, membawa <b>Bukti pendaftaran & Kelengkapan Berkas PPDB SMA NEGERI 1 BELITANG</b>. </li>
                                ...
                                <li>Jika Calon Siswa sudah mengambil <b>NOMOR TEST & Pengecekan Ruang Ujian</b> selanjutnya Calon Siswa wajib melakukan <b>TEST tertulis POTENSI AKADEMIK</b>.</li>
																<li>PENGUMUMAN HASIL PPDB Online bisa dilihat di Web PPDB SMA NEGERI 1 BELITANG. Untuk <b>No. Pendaftaran</b> sesuaikan dengan <b>Formulir No. Pendaftaran</b> & <b>Passwordnya</b> yaitu <b>NISN</b> Calon Siswa tersebut.</li>
																<li>Jika Calon Siswa dinyatakan <b>LULUS</b> maka Calon Siswa Wajib <b>Registrasi/Daftar Ulang</b> di <b>SMA NEGERI 1 BELITANG</b>.</li>
															</ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <hr class="star-light">
                    <h4>
                        JL.Marga Pemuka Bangsa Raja No.1001 Gumawang Belitang, 32382<br>
                        Kab.OKU Timur, Indonesia <br><br>
                    </h4>
                    <span style="color:#222;"><b><i class="fa fa-phone-square"></i> 0735-450106</b> </span>
										&nbsp;
                    <span class="eml" style="color:#222;"><i class="fa fa-envelope"></i> smanegeri1belitang@gmail.com</span>
                    <br>
                    <a href="http://www.sman1belitang.sch.id" target="_blank"><h4 class="btn btn-success">SMA NEGERI 1 BELITANG </h4></a>
                </div>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">SMA NEGERI 1 BELITANG</a> <?php echo date('Y'); ?> | IT Development
                    </div>
                </div>
            </div>
        </div>
